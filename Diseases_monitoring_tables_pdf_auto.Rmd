...
source("scripts/Web scrapping and data cleaning.R")

```


```{r Dengue_Nepal, fig.width=7, fig.height=3, echo=FALSE}
save_data <- readRDS(file = "data/save_data_nepal_dengue.Rdata")
...
my_data <- readRDS(file = "data/sri_lanka_dengue.Rdata")
...
save_data <- readRDS(file = "data/sri_lanka_dengue_ggplot.Rdata")
save_data$Month <-factor(save_data$Month, 
                         levels = c("Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                    "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"))
...
my_data<- readRDS(file = "data/save_data_fiji_dengue.Rdata")
...
save_data<- readRDS(file = "data/save_data_fiji_dengue_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/french_polynesia_dengue.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/french_polynesia_dengue_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/marshall_dengue.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/marshall_dengue_ggplot.Rdata")
save_data$Month <-factor(save_data$Month, 
                         levels = c("Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                    "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"))
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/Malaysia_dengue.Rdata")
...
DT::datatable(
  ...
  formatStyle(columns = "2020",
              ...
              backgroundColor = styleEqual(levels = c(0,1,2), values = c("#008000","#FFA500","#F00")))
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/Malaysia_dengue_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/afghanistan_polio.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/afghanistan_polio_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/pakistan_polio.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/pakistan_polio_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/Bangladesh_Measles.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/Bangladesh_Measles_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/Bangladesh_Diarrhea.Rdata")
...
#readRDS processed data for ggplot graph
save_data<- readRDS(file = "data/Bangladesh_Diarrhea_ggplot.Rdata")
...
#readRDS processed data from sourced file
my_data<- readRDS(file = "data/save_data_srilanka_drought.Rdata")
